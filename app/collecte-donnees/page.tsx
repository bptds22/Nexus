...
import { SECTIONS_COLLECTE_DONNEES as SECTIONS } from "@/content/legal/collecte-donnees";
...
/* ─────────────────────────────────────────────────────────────────
   ...
   components/legal/. Le modèle plat `{ content, bullets?, after? }`
   d'origine a été normalisé vers le Block model unifié, avec le
   flag `trailing: true` sur les paragraphes `after` pour préserver
   le rendu original mt-4 (vs mb-4 par défaut). Rendu HTML/CSS
   byte-identique aux PDFs.
───────────────────────────────────────────────────────────────── */
