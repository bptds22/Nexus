...
function PreviewPlayerCard({ a }: { a: AthleteProfileRecruiterView }) {
        ...
        <div className="rounded-full" style={{ border: "3px solid #111317" }}>
          {badgeActive ? (
            <svg width="48" height="48" viewBox="0 0 54 54" fill="none">
              <defs>
                <radialGradient id="adm_pc_bg" cx="38%" cy="28%" r="68%">
              ...
              <circle cx="27" cy="27" r="24" fill="url(#adm_pc_bg)" />
