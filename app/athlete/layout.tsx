...
const NAV_ITEMS = [
  ...
  {
    label: "Trouver mon cégep",
    href: "/athlete/recherche",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    /* Placée après « Mon équipe », avant Notifications : c'est un acte
       volontaire de l'athlète, pas un réglage ni une boîte de réception.
       PAS de badgeKey — rien n'y attend l'athlète. Les trois pastilles
       existantes signalent quelque chose à TRAITER (messages non lus,
       suggestions en attente, invitations) ; en poser une ici pour un
       compteur qui ne demande aucune action banaliserait les autres. */
    label: "Ambassadeur",
    href: "/athlete/ambassadeur",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
