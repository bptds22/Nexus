...
// Default state stays muted gray via .nx-social-icon. On hover we
// switch to the platform brand color per icon (Tailwind arbitrary
// color class) — the existing SVG uses fill="currentColor" so this
// picks up cleanly. The .nx-social-icon hover styles in globals.css
// also still apply (scale + drop-shadow). hoverColor is the only
// thing that varies per row.
const SOCIALS = [
  {
    name: "Instagram",
    href: "#",
