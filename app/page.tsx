...
// Default state stays muted gray via .nx-social-icon. On hover the
// .nx-social-icon:hover rule reads --hover-color (set per icon via
// the inline style attribute) and applies it as the icon color.
// SVGs use fill="currentColor" so the color flows through naturally.
// hoverColor is the platform's brand hex, set as the CSS variable.
const SOCIALS = [
  {
    name: "Instagram",
    href: "#",
