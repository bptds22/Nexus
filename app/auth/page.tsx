                ...
                <>
                  ...
                  {showAthleteForm && (
                    <div ref={formRef}>
                      ...
                      {/* Social login */}
                      <button type="button" onClick={() => handleOAuth("google")} className="flex items-center justify-center gap-3 h-11 w-full bg-[#111317] border border-white/10 rounded-lg text-sm text-white hover:border-white/20 transition-colors mb-3">
                      ...
                      <button type="button" onClick={() => handleOAuth("apple")} className="flex items-center justify-center gap-3 h-11 w-full bg-black border border-white/15 rounded-lg text-sm text-white hover:border-white/30 transition-colors mb-4">
