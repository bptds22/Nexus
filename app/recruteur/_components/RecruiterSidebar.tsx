...
const RECRUITER_ITEMS: NavItem[] = [
  ...
  {
    // Pas de requiredTier : le tier Free doit ATTEINDRE la page, où il
    // rencontre le mur (planche lock + CTA Pro). Un lock de sidebar
    // ouvrirait l'UpgradeModal et la page ne serait jamais rendue.
    label: "Calendrier", href: "/recruteur/calendrier",
