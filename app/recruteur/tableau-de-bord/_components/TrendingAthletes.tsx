...
/* ─────────────────────────────────────────────────────────────────
   Zone 3 — ATHLÈTES TENDANCE
   Same pattern as coach HotAthletes — ranked list with views.
───────────────────────────────────────────────────────────────── */
...
export default function TrendingAthletes({ athletes }: { athletes: TrendingAthlete[] }) {
  return (
    <div className="bg-[#1A1D24] rounded-xl border border-[#2D3748] overflow-hidden">
      ...
      <div className="px-5 pt-5 pb-4">
        ...
        <p className="text-[13px] text-[#9CA3AF] mt-1">Les plus consultés cette semaine en Football</p>
      </div>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-0.5">
                ...
                <span className="text-[12px] text-[#6b7280]">{a.school}</span>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center gap-1.5 text-[#9CA3AF] shrink-0 w-[90px] justify-end">
              <HeartIcon />
              <span className="text-[14px] font-bold text-white">{a.favoritedBy}</span>
