...
> _I never really understood how_ `damping`_,_ `mass` _and_ `stiffness` _influence a spring animation, so I made a_ [_tool for myself_](https://emilkowal.ski/ui/great-animations#great-animations-feel-natural) _to visualise it.  
