...
export const ACTIVITY_TYPE_CONFIG: Record<ActivityType, ActivityTypeConfig> = {
  message_received:        { icon: "message-circle", borderColor: "#3B82F6", label: "Messages" },
  athlete_favorited:       { icon: "heart",          borderColor: "#E63946", label: "Favoris" },
  video_added:             { icon: "film",           borderColor: "#8B5CF6", label: "Vidéos" },
  ...
  scouting_report:         { icon: "file-text",      borderColor: "#F59E0B", label: "Notes" },
  athlete_added:           { icon: "user-plus",      borderColor: "#E63946", label: "Nouveaux athlètes" },
  letter_of_intent:        { icon: "pen-tool",       borderColor: "#E63946", label: "Lettres d'intention" },
  profile_viewed:          { icon: "eye",            borderColor: "#3B82F6", label: "Consultations" },
  profile_incomplete:      { icon: "alert-triangle", borderColor: "#F59E0B", label: "Profils incomplets" },
  new_athlete_in_sport:    { icon: "user-plus",      borderColor: "#E63946", label: "Nouveaux athlètes" },
